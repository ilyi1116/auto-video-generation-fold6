...
class CICDValidator:
    ...
    def validate_workflow_paths(self, filename: str, workflow: Dict[Any, Any]):
        ...
        # 检查过时的路径引用
        outdated_paths = ["frontend/", "services/", "requirements.txt"]
    ...
    def validate_docker_configs(self):
        ...
        compose_files = ["docker-compose.yml", "docker-compose.unified.yml"]
    ...
    def validate_github_secrets(self):
        ...
        required_secrets = ["SNYK_TOKEN", "SEMGREP_APP_TOKEN", "KUBE_CONFIG"]

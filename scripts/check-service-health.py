...
class ServiceHealthChecker:
    ...
    async def check_http_health(self, session: aiohttp.ClientSession, 
    ...
    async def check_all_services(self) -> None:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            for name, config in self.services.items():
                ...
                logger.info(f"{status_icon} {name:<20} {result['response_time']:>6}ms{critical_marker}")
    ...
    def save_report(self) -> None:
        ...
        logger.info(f"📄 Health check report saved to: health-check-report.json")

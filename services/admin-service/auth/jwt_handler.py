...
class JWTHandler:
    ...
    def create_refresh_token(self, user_id: str, username: str, session_id: str) -> str:
        """
        創建刷新令牌
    ...
    def revoke_token(self, token: str):
        ...
        try:
            ...
            # 如果是刷新令牌，標記為非活躍
            payload = jwt.decode(
                token, self.public_key, algorithms=[self.algorithm], options={"verify_exp": False}
            )
    ...
    def get_active_sessions(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        for jti, token_info in self.refresh_tokens.items():
            if (
                ...
                and token_info["is_active"]
                and token_info["expires_at"] > datetime.utcnow()
            ):

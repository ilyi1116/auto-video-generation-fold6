...
class CostPredictor:
    ...
    async def _train_category_model(self, cost_data: List[CostRecord], category: CostCategory):
        ...
        # 準備特徵矩陣
        features = [
            'days_since_start', 'hour', 'day_of_week', 
            'day_of_month', 'month', 'rolling_mean_7d', 'rolling_std_7d'
        ]
    ...
    async def _generate_category_recommendations(
        ...
        for rule_name, rule_config in rules.items():
            ...
            recommendation = OptimizationRecommendation(
                ...
                estimated_impact_days=self._estimate_impact_days(rule_config["implementation_effort"]),
        ...
        try:
            ...
            analysis_result = {
                ...
                'summary': {
                    ...
                    'high_priority_recommendations': len([r for r in recommendations if r.potential_savings > 100]),
                    'anomalies_detected': len(anomalies),
                    'budgets_exceeded': len([b for b in budget_status if b['status'] == 'exceeded'])
                }
            }

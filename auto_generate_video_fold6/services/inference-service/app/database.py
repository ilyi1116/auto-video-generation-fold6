...
from sqlalchemy import create_engine, MetaData, Table, Column, Integer, String, DateTime, Text, Boolean, ForeignKey, Float
...
synthesis_jobs = Table(
    ...
    Column('status', String(20), nullable=False, default='pending'),  # pending, processing, completed, failed

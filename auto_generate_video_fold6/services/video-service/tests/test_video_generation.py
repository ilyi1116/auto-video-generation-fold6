...
class TestVideoGenerationAPI:
    ...
    def test_custom_video_generation(self, client, mock_auth, mock_video_service):
        ...
        request_data = {
            ...
            "platform": "youtube",
            "length": "medium",
            "voice_settings": {"voice_id": "nova", "speed": 1.0, "emotion": "professional"},
    ...
    def test_generation_status(self, client, mock_auth, mock_video_service):
        ...
        response = client.get(
            "/api/v1/video/status/gen_123", headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_cancel_generation(self, client, mock_auth, mock_video_service):
        ...
        response = client.post(
            "/api/v1/video/cancel/gen_123", headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_get_templates(self, client, mock_auth):
        ...
        response = client.get(
            "/api/v1/video/templates", headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_get_presets(self, client, mock_auth):
        ...
        response = client.get(
            "/api/v1/video/presets", headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_get_history(self, client, mock_auth):
        ...
        response = client.get(
            "/api/v1/video/history", headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_cleanup_generation(self, client, mock_auth, mock_video_service):
        ...
        response = client.delete(
            "/api/v1/video/cleanup/gen_123", headers={"Authorization": "Bearer test_token"}
        )
...
class TestVideoGenerationService:
    ...
    def test_completion_time_estimation(self):
        ...
        request = VideoGenerationRequest(
            topic="Test", video_length="long", quality="ultra", include_music=True
        )

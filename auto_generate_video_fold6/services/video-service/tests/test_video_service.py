...
class TestVideoGeneration:
    ...
    def test_create_video_project_success(self, mock_db, mock_verify_token, sample_video_request):
        ...
        response = client.post("/api/v1/video/generate", 
...
class TestAIIntegration:
    ...
    async def test_gemini_script_generation(self, sample_script_response):
        ...
        with patch.object(client, '_generate_content') as mock_generate:
            ...
            with patch.object(client, '_parse_script_response', return_value={
    ...
    async def test_stable_diffusion_image_generation(self):
        ...
        with patch.object(client, '_get_session') as mock_session:
            ...
            with patch.object(client, '_save_image', return_value=("http://test.com/image.png", "http://test.com/thumb.jpg")):
    ...
    async def test_video_composer_creation(self, sample_script_response):
        ...
        with patch.object(composer, '_download_media') as mock_download:
            ...
            with patch.object(composer, '_create_preview', return_value="/tmp/preview.mp4"):
                with patch.object(composer, '_upload_media', return_value="http://test.com/preview.mp4"):
                    ...
                    result = await composer.create_video(
                        ...
                        image_urls=["http://test.com/img1.png", "http://test.com/img2.png", "http://test.com/img3.png"],
                        include_captions=True,
                        target_platform="youtube"
                    )

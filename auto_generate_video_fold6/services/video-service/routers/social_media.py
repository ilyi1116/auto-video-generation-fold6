...
async def get_available_platforms(
    ...
    try:
        ...
        return {
            "platforms": available_info,
            "total": len(available_info)
        }
...
async def check_platform_health(
    ...
    try:
        ...
        for platform, health in health_results.items():
            connections.append(PlatformConnectionResponse(
                platform=platform,
...
async def get_video_stats(
    ...
    try:
        ...
        logger.error("Failed to get video stats", error=str(e), platform=platform, platform_id=platform_id)
...
async def delete_video_from_platform(
    ...
    try:
        ...
        if success:
            ...
            return {"message": "Video deleted successfully", "platform": platform, "platform_id": platform_id}
        else:
        ...
        logger.error("Video deletion failed", error=str(e), platform=platform, platform_id=platform_id)
            ...
            "video_templates": [
                {
                    ...
                    "structure": ["Hook", "Introduction", "Main Content", "Recap", "Call to Action"],

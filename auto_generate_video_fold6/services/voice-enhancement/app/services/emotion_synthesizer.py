...
class EmotionSynthesizer:
    ...
    def __init__(self):
        ...
        self.supported_emotions = [
            ...
            "surprise", "disgust", "excited", "calm", "confident"
        ]
        self.supported_languages = ["zh-CN", "zh-TW", "en-US", "ja-JP", "ko-KR"]
    ...
    async def synthesize_with_emotion(
        ...
        """
        try:
            logger.info("開始情感語音合成", 
                       text=text[:50], emotion=emotion, language=language)
    ...
    def _get_emotion_parameters(self, emotion: str, intensity: float) -> Dict:
        ...
        params = base_params.get(emotion, {
            "pitch_factor": 1.0,
            "speed_factor": 1.0,
            "volume_factor": 1.0
        })

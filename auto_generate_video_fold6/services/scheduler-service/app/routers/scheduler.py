...
from ..schemas import (
    SchedulePostRequest, SchedulePostResponse, UpdateScheduleRequest,
    PlatformAccountRequest, PlatformAccountResponse, ScheduleListResponse,
    PostStatus, PlatformType
)
...
async def get_scheduled_posts(
    ...
    posts = query.order_by(ScheduledPost.scheduled_time.desc())\

...
class TextGenerator:
        ...
        try:
            ...
            result = {
                ...
                "improvement_percentage": round(
                    ((current_duration - abs(optimized_duration - target_duration)) / current_duration) * 100, 2
                )
            }
    ...
    def _build_script_prompt(
        self, topic: str, style: str, duration_seconds: int,
        target_audience: str, keywords: List[str], tone: str
    ) -> str:
...
Please provide ONLY the optimized script content."""
    ...
    def _select_best_title(self, titles: List[str], style: str, max_length: int) -> str:
        ...
        for title in titles:
            ...
            if style == "catchy":
                ...
                power_words = ['secret', 'hack', 'amazing', 'incredible', 'game-changing', 'revolutionary']
                ...
                curiosity_words = ['you won\'t believe', 'shocking', 'surprising', 'nobody tells you']
    ...
    def _analyze_changes(self, original: str, optimized: str) -> List[str]:
        ...
        if original_sentences != optimized_sentences:
            changes.append(f"Sentence count changed from {original_sentences} to {optimized_sentences}")

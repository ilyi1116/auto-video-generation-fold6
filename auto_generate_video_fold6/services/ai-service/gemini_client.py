...
class GeminiClient:
    ...
    async def analyze_image(self, image_data: bytes, prompt: str = "分析這張圖片") -> GeminiResponse:
        """分析圖片"""
    ...
    async def generate_script(self, topic: str, platform: str = "tiktok", style: str = "engaging") -> GeminiResponse:
        """生成影片腳本"""
...
"""
    ...
    async def optimize_content(self, content: str, platform: str, target_audience: str = "年輕人") -> GeminiResponse:
        """優化內容"""
        system_instruction = f"""

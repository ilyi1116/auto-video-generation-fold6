...
from ..schemas import (
    TrendingTopicResponse, ViralContentResponse, 
    PlatformType, TrendSuggestion
)
...
async def get_viral_content(
    ...
    viral_content = query.order_by(
        ViralContent.viral_score.desc(),
        ViralContent.discovered_at.desc()
    ).limit(50).all()
...
async def get_keyword_performance(
    ...
    platform_list = platforms.split(",") if platforms else ["google", "youtube", "tiktok", "instagram"]

...
declare module '$env/static/private' {
	...
	export const VITE_ENABLE_AI_FEATURES: string;
	export const VITE_ENABLE_VIDEO_PROCESSING: string;
	export const VITE_ENABLE_SOCIAL_FEATURES: string;
	...
	export const MonkeyDevDeviceIP: string;
	...
	export const MonkeyDevPath: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VITE_ENABLE_VIDEO_PROCESSING: string;

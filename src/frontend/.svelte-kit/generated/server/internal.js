...
export const options = {
	...
	csp: {"mode":"hash","directives":{"child-src":["none"],"default-src":["self"],"connect-src":["self","http://localhost:8001","ws://localhost:*"],"font-src":["self","data:","https:"],"img-src":["self","data:","https:"],"media-src":["self"],"object-src":["none"],"script-src":["self"],"style-src":["self","unsafe-inline"],"base-uri":["self"],"form-action":["self"],"frame-ancestors":["none"],"upgrade-insecure-requests":false,"block-all-mixed-content":false},"reportOnly":{"upgrade-insecure-requests":false,"block-all-mixed-content":false}},

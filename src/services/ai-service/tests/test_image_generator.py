"""
測試 image_generator 服務
"""

from unittest.mock import AsyncMock, Mock, patch

import pytest
from app.services.image_generator import *  # TODO: 導入具體的類和函數
...
class TestImagegeneratorService:
    ...
    @patch("app.services.image_generator.external_dependency")
...
# TODO: 添加更多特定於 image_generator 的測試
# TODO: 添加集成測試
# TODO: 添加性能測試（如需要）

...
import pytest
from app.services.ai_manager import *  # TODO: 導入具體的類和函數


class TestAimanagerService:
    """測試 ai_manager 服務"""
    ...
    @patch("app.services.ai_manager.external_dependency")

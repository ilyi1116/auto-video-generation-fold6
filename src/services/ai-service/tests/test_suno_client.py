...
from app.services.suno_client import *  # TODO: 導入具體的類和函數


class TestSunoclientService:
    """測試 suno_client 服務"""
    ...
    @patch('app.services.suno_client.external_dependency')

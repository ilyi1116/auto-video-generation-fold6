...
# 運行容器
docker run -p 8004:8004 --env-file .env video-service
```
...
預期響應：
```json
{"status": "healthy", "service": "video-service", "version": "1.0.0"}
```
...
# Kubernetes 環境
kubectl logs -f deployment/video-service
```

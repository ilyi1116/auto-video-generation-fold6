...
class ConfigManager:
    ...
    def __init__(self, config_dir: str = "/data/data/com.termux/files/home/myProject/config"):
        ...
        self._encryption_key = os.getenv("CONFIG_ENCRYPTION_KEY", "default-key-change-in-production")
    ...
    async def set_config(self, name: str, config: Dict[str, Any], 
    ...
    async def _save_config_to_file(self, name: str, config: Dict[str, Any], metadata: ConfigMetadata):
        """保存配置到文件"""
        try:
            # 確定文件路徑

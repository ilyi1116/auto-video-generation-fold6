...
from .models import SYSTEM_PERMISSIONS, SYSTEM_ROLES, Permission, Role
...
class RoleManager:
    ...
    def delete_role(self, role_id: str) -> bool:
        ...
        # 檢查是否有用戶正在使用此角色
        users_with_role = [
            user_id for user_id, roles in self.user_roles.items() if role_id in roles
        ]
    ...
    def create_permission(
        self, name: str, resource_type: str, permission_type: str, description: Optional[str] = None
    ) -> Permission:
        """
        創建新權限
    ...
    def export_roles(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "permissions": {perm_id: perm.to_dict() for perm_id, perm in self.permissions.items()},

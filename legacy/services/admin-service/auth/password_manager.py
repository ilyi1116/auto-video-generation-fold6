...
class PasswordManager:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.default_policy = PasswordPolicy(
            ...
            forbidden_patterns=self.config.get(
                "forbidden_patterns", ["password", "123456", "qwerty", "admin", "root", "guest"]
            ),
    ...
    def check_password_strength(self, password: str, username: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "warnings": (
                    result["feedback"]["warning"] if result["feedback"]["warning"] else None
                ),
            }
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_password_entries": sum(
                len(history) for history in self.password_history.values()
            ),

...
class TrendingKeyword(Base):
    ...
    def __repr__(self):
        return (
            f"<TrendingKeyword(platform={self.platform}, keyword={self.keyword}, rank={self.rank})>"
        )
...
class CrawlerTask(Base):
    ...
    task_results = relationship(
        "CrawlerTaskResult", back_populates="task", cascade="all, delete-orphan"
    )
